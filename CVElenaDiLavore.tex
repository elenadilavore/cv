...
\begin{itemize}
  ...
  \item Reviewer for conferences (LiCS, MFPS, ...) and journals (LMCS, MSCS, TAC, RAIRO, ...).
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
  \item (Spring 2024) Co-supervision of the BSc thesis of Anna Ricci at the University of Pisa, with Filippo Bonchi, published in CSL2025~\cite{2024inductionupto}.
