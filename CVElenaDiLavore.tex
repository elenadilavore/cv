...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Publications and preprints}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
  \item (2022) Program commitee member of the Applied Category Theory conference.
  \item (2022-2023) Organiser of the Applied Category Theory Adjoint School.
  \item Reviewer for conferences (LiCS, MFPS) and journals (TAC, RAIRO).
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
