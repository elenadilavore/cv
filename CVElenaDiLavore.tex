...
Address: Largo Bruno Pontecorvo 3, Pisa, Italy & +393665334335 \\
\end{tabular*}
\\
\ \\
\ \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
  \item (since Dec 2023) Member of the steering committee of the Applied Category Theory Adjoint School.
...
\item[] \ressubheading{Tallinn University of Technology}{Estonia}{PhD}{2019 - 2023}
...
\begin{itemize}
  \item[] \textbf{Language skills:} Italian (native speaker), English (C1).
